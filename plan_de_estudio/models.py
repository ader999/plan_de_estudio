...
class Guia(models.Model):
    ...
    tiempo_minutos_2 = models.IntegerField(verbose_name="Tiempo minutos 2", validators=[MinValueValidator(1)])
    ...
    tiempo_minutos_3 = models.IntegerField(verbose_name="Tiempo minutos 3", validators=[MinValueValidator(1)],)
    ...
    tiempo_minutos_4 = models.IntegerField(verbose_name="Tiempo minutos 4", validators=[MinValueValidator(1)])
