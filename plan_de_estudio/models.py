...
class Silabo(models.Model):
    ...
    actividad_aprendizaje = models.TextField(verbose_name='Actividad de aprendizaje', null=True, blank=True)
    tecnica_evaluacion = MultiSelectField(max_length=200, choices=TECNICA_EVALUACION_LIST, verbose_name='Técnica de evaluación', max_choices=2, null=True, blank=True)
    tipo_evaluacion = MultiSelectField(max_length=200, choices=TIPO_EVALUACION_LIST, verbose_name='Tipo de evaluación', max_choices=2, null=True, blank=True)
    periodo_tiempo_programado = models.CharField(max_length=100, choices=PERIODO_TIEMPO_LIST, verbose_name='Periodo de tiempo programado', null=True, blank=True)
    tiempo_minutos = models.IntegerField(verbose_name='Tiempo en minutos', null=True, blank=True, validators=[MinValueValidator(0)])
    agente_evaluador = MultiSelectField(max_length=200, choices=AGENTE_EVALUADOR_LIST, verbose_name='Agente evaluador', max_choices=2, null=True, blank=True)
    instrumento_evaluacion = models.CharField(max_length=100, choices=INSTRUMENTO_EVALUACION_LIST, verbose_name='Instrumento de evaluación', null=True, blank=True)
    criterios_evaluacion = models.TextField(verbose_name='Criterios de evaluación', null=True, blank=True)
    puntaje = models.IntegerField(verbose_name='Puntaje', null=True, blank=True, validators=[MinValueValidator(0)])
