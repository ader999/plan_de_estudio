...
function validarFormulario() {
    ...
    if (sumaPuntajes !== 100) {
        alert('La suma de los puntajes debe ser exactamente 100 puntos. Actualmente suma: ' + sumaPuntajes);
        return false;
    }
...
function recopilarDatosFormulario() {
    ...
    formData.agente_evaluador_1 = $('#agente_evaluador_1').val();
    formData.tiempo_minutos_1 = $('#tiempo_minutos_1').val();
    formData.recursos_didacticos_1 = $('#recursos_didacticos_1').val();
    formData.periodo_tiempo_programado_1 = $('#periodo_tiempo_programado_1').val();
    ...
    formData.agente_evaluador_2 = $('#agente_evaluador_2').val();
    formData.tiempo_minutos_2 = $('#tiempo_minutos_2').val();
    formData.recursos_didacticos_2 = $('#recursos_didacticos_2').val();
    formData.periodo_tiempo_programado_2 = $('#periodo_tiempo_programado_2').val();
    ...
    formData.agente_evaluador_3 = $('#agente_evaluador_3').val();
    formData.tiempo_minutos_3 = $('#tiempo_minutos_3').val();
    formData.recursos_didacticos_3 = $('#recursos_didacticos_3').val();
    formData.periodo_tiempo_programado_3 = $('#periodo_tiempo_programado_3').val();
    ...
    formData.agente_evaluador_4 = $('#agente_evaluador_4').val();
    formData.tiempo_minutos_4 = $('#tiempo_minutos_4').val();
    formData.recursos_didacticos_4 = $('#recursos_didacticos_4').val();
    formData.periodo_tiempo_programado_4 = $('#periodo_tiempo_programado_4').val();
            ...
            if (response.success) {
                ...
                if (response.guia_id) {
                    if ($('#guia_id').length) {
                        ...
                        $('#formEstudioIndependiente').append('<input type="hidden" id="guia_id" name="guia_id" value="' + response.guia_id + '">');
                    }
                }
...
function actualizarSumaPuntajes() {
    ...
    if (sumaPuntajes !== 100) {
        $('#sumaPuntajes').text('Suma actual: ' + sumaPuntajes + ' puntos (debe ser 100)').removeClass('text-success').addClass('text-danger');
    } else {
        $('#sumaPuntajes').text('Suma correcta: 100 puntos').removeClass('text-danger').addClass('text-success');
    }
}
...
function generarEstudioIndependiente(asignacionId, silaboId) {
    ...
    if (silaboId && silaboId !== 'null' && silaboId.trim() !== '') {
    ...
    } else if (asignacionId && asignacionId !== 'null' && asignacionId.trim() !== '') {
        ...
        alert('Error: No se pudo identificar el sílabo para generar el estudio independiente');
        return;
    }
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.success) {
                ...
                $('#actividad_aprendizaje_1').val(response.datos.actividad_aprendizaje_1);
                $('#tecnica_evaluacion_1').val(response.datos.tecnica_evaluacion_1);
                $('#tipo_evaluacion_1').val(response.datos.tipo_evaluacion_1);
                $('#instrumento_evaluacion_1').val(response.datos.instrumento_evaluacion_1);
                ...
                $('#periodo_tiempo_programado_1').val(response.datos.periodo_tiempo_programado_1);
                ...
                $('#actividad_aprendizaje_2').val(response.datos.actividad_aprendizaje_2);
                $('#tecnica_evaluacion_2').val(response.datos.tecnica_evaluacion_2);
                $('#tipo_evaluacion_2').val(response.datos.tipo_evaluacion_2);
                $('#instrumento_evaluacion_2').val(response.datos.instrumento_evaluacion_2);
                ...
                $('#periodo_tiempo_programado_2').val(response.datos.periodo_tiempo_programado_2);
                ...
                $('#actividad_aprendizaje_3').val(response.datos.actividad_aprendizaje_3);
                $('#tecnica_evaluacion_3').val(response.datos.tecnica_evaluacion_3);
                $('#tipo_evaluacion_3').val(response.datos.tipo_evaluacion_3);
                $('#instrumento_evaluacion_3').val(response.datos.instrumento_evaluacion_3);
                ...
                $('#periodo_tiempo_programado_3').val(response.datos.periodo_tiempo_programado_3);
                ...
                $('#actividad_aprendizaje_4').val(response.datos.actividad_aprendizaje_4);
                $('#tecnica_evaluacion_4').val(response.datos.tecnica_evaluacion_4);
                $('#tipo_evaluacion_4').val(response.datos.tipo_evaluacion_4);
                $('#instrumento_evaluacion_4').val(response.datos.instrumento_evaluacion_4);
                ...
                $('#periodo_tiempo_programado_4').val(response.datos.periodo_tiempo_programado_4);
...
$(document).ready(function() {
    ...
    var asignacionId = typeof ASIGNACION_ID !== 'undefined' ? ASIGNACION_ID : null;
    ...
    $('#puntaje_1, #puntaje_2, #puntaje_3, #puntaje_4').on('change keyup', function() {
        actualizarSumaPuntajes();
